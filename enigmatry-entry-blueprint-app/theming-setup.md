...
In the scss file where you include a generator, you can define a custom theme map that will be expanded with various customization options. After that, include and apply the styles generated by the generate-from mixin in the 'generator' module, using the customization options provided in the $custom-theme map.
