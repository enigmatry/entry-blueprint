...
className: `entry-producer-id-field entry-autocomplete`,
        ...
        'templateOptions.label': (model) => (this.fieldsLabelExpressions?.producerId ? this.fieldsLabelExpressions.producerId(model) : $localize `:@@products.product-edit.producer-id.label:Producer`),
        ...
        templateOptions: {
        label: $localize `:@@products.product-edit.producer-id.label:Producer`,
        placeholder: $localize `:@@products.product-edit.producer-id.placeholder:Producer`,
        description: '',
appearance: 'outline',
...
defaultValue: '2022-01-01T12:00:00.0000000+00:00',
        ...
        'templateOptions.label': (model) => (this.fieldsLabelExpressions?.discountExpiresOn ? this.fieldsLabelExpressions.discountExpiresOn(model) : $localize `:@@products.product-edit.discount-expires-on.label:Discount expires on`),
        ...
        templateOptions: {
        label: $localize `:@@products.product-edit.discount-expires-on.label:Discount expires on`,
        placeholder: $localize `:@@products.product-edit.discount-expires-on.placeholder:Discount expires on`,
        description: '',
appearance: 'outline',
            attributes: {  },
            hidden: !true,
