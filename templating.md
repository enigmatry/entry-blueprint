...
``dotnet new install Enigmatry.Blueprint.Template --add-source https://pkgs.dev.azure.com/enigmatry/b3d80552-b808-495c-9332-82888c12c1bf/_packaging/enigmatry-blueprint-template-feed/nuget/v3/index.json``
...
``dotnet new install Enigmatry.Blueprint.Template::VERSION --add-source https://pkgs.dev.azure.com/enigmatry/b3d80552-b808-495c-9332-82888c12c1bf/_packaging/enigmatry-blueprint-template-feed/nuget/v3/index.json``
