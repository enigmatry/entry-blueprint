...
namespace Enigmatry.Blueprint.Data.Migrations.Migrations
{
    ...
    [Migration("20230413064920_AddDiscountExpiresOn")]
    partial class AddDiscountExpiresOn
    {
            ...
            modelBuilder.Entity("Enigmatry.Blueprint.Domain.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "",
                            Discount = 25f,
                            DiscountExpiresOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            FreeShipping = true,
                            HasDiscount = true,
